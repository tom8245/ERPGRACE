            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo $Menu == "ApplyLeave" ? "active" : "" ?>"
                                href="../Leave/ApplyLeave.php?Menu=ApplyLeave">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo $Menu == "ManageLeave" ? "active" : "" ?>"
                                href="../Leave/ManageLeave.php?Menu=ManageLeave">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
