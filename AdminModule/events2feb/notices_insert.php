...
<script>
  ...
  if (isset($_POST["insert"])) {
    ...
    $sql = "INSERT INTO erp_news (news_title, news_desc, news_postby, news_status,news_type) VALUES ('$notice_title', '$notice_desc', '$posted_by','$status','notice')";
  ...
  if (isset($_POST["save"])) {
    ...
    $sql = "INSERT INTO erp_news (news_title, news_desc, news_status, news_type)
        VALUES ('$notice_title','$notice_subject','$status','notice')";
