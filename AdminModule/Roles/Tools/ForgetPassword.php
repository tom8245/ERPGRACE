...
<head>
    ...
    <title>Grace ERP | Reset Password</title>
        ...
        <section>
            <div class="content">
                ...
                <div class="erp_info">
                    ...
                    <div class="erp_login">
                        <h5 style='color: rgb(128,0,128);'>GRACE ERP Reset Password :</h5>

                        <div class="erp_login_field">

                            <a class="Register" href="../Login.php">Reset success ? click to login</a>
                            ...
                            <form action="" id="registrationForm">
                                ...
                                <div class="form-container">
                                    ...
                                    <input type="password" id="password" name="password" required class="input" pattern=".{8,}" title="Password must be at least 8 characters long" placeholder="Enter your new password">
                                </div>
                                ...
                                <div class="form-container">
                                    ...
                                    <input type="password" id="confirmPassword" name="confirmPassword" required class="input" placeholder="Confirm new password">
                                </div>
                                ...
                                <button type="button" id="signupButton">Reset Password</button><br><br>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#generateButton').click(function(event) {
                ...
                $.ajax({
                    url: 'ResetPassword/VerificationCodeSender.php',
                    type: 'POST',
                    data: {
            ...
            $('#signupButton').click(function(event) {
                ...
                $.ajax({
                    url: 'ResetPassword/ResetPassword.php',
                    type: 'POST',
                    data: {
                        VerificationCode: true,
                        username: $('#username').val(),
