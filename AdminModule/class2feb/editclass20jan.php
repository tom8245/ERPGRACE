            ...
            <form id="TTform" method="post" action="#" class="TT-form">
                <div class="TT-form-content">
                    ...
                    <div>
                        ...
                        <input type="text" name="course" placeholder="Enter Course" readonly value="<?php echo $data['cls_course']; ?>" />
                    </div>
                    <div>
                        <label for="department">Department</label>
                        <input type="text" name="department" placeholder="Enter Department Abbr" readonly value="<?php echo $data['cls_dept']; ?>" />
                    </div>
                    <div>
                        <label for="deptname">Department Name</label>
                        <input type="text" name="deptname" placeholder="Enter Department Name" readonly value="<?php echo $data['cls_deptname']; ?>" />
                    </div>
                    <div>
                        <label for="deptcode">Department Code</label>
                        <input type="text" name="deptcode" placeholder="Enter Department Code" readonly value="<?php echo $data['cls_deptcode']; ?>" />
                    </div>
                    <div>
                        <label for="startyear">Start Year</label>
                        <input type="text" name="startyear" placeholder="Enter Start Year" readonly value="<?php echo $data['cls_startyr']; ?>" />
                    </div>
                    <div>
                        <label for="endyear">End Year</label>
                        <input type="text" name="endyear" placeholder="Enter End Year" readonly value="<?php echo $data['cls_endyr']; ?>" />
                    </div>
                    <div>
