                            ...
                            if (is_array($classmsg)) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger" onclick="if(confirm('Are you sure you want to delete this item?')) { window.location.href = 'delClass.php?id=<?php echo $data['cls_id']; ?>'; }">Delete</button>
                                        </td>
                                    </tr>
                                <?php
                                }
