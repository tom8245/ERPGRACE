        ...
        <table class="table">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $i ?></td>
                        <td><a href="../userProfile/StudentUser/ViewStudent.php?sid=<?php echo $student['stu_id'] ?>" target='WikipediaWindow'><?php echo $student['stu_fname'] . ' ' . $student['stu_lname'] ?></a></td>
