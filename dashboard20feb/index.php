...
session_start();
$faculty_access = $_SESSION['access'];
$faculty_access = explode(',', $faculty_access);
...
<div class="sidebar-links">
    <ul>
        ...
        <!-- <div class="active-tab"></div> -->
            <?php foreach ($faculty_access as $access) {
                if ($access == 'home') {

            ?>
        <li class="tooltip-element" data-tooltip="0">
                    <a href="./home.php" target="output_source" class="active">
                        <div class="icon">
...
<?php foreach ($faculty_access as $access) {
if ($access == 'attendance_posting') {

?>
<li class="tooltip-element" data-tooltip="3">
    <a href="../attendance/Attendance/FormPage.php" target="output_source">
        <div class="icon">
...
<?php foreach ($faculty_access as $access) {
if ($access == 'result_posting') {

?>
<li class="tooltip-element" data-tooltip="4">
    <a href="../result/Result-pos/FormPage.php" target="output_source">
        <div class="icon">
...
<li class="tooltip-element" data-tooltip="6">
    <a href="../gallery/" target="output_source">
        <div class="icon">
...
<li class="tooltip-element" data-tooltip="7">
    <a href="../userProfile/index.php" target="output_source">
        <div class="icon">
...
<?php foreach ($faculty_access as $access) {
if ($access == 'view_calendar') {

?>
<li class="tooltip-element" data-tooltip="8">
    <a href="../calendar/" target="output_source">
        <div class="icon">
...
<?php foreach ($faculty_access as $access) {
if ($access == 'change_passsword') {

?>
<li class="tooltip-element" data-tooltip="9">
    <a href="../change_password/" target="output_source">
        <div class="icon">
            <i class='bx bx-key'></i>
